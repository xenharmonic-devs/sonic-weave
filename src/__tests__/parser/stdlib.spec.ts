...
describe('SonicWeave standard library', () => {
  ...
  it('generates well-temperaments', () => {
    ...
    expect(werckmeister3.map(i => i.toString()).join(';')).toBe(
      '92.17871646099638383r c;193.15685693241744048r c;294.13499740383849712r c;391.6902862640135936r c;498.04499913461268079r c;590.22371559560951937r c;696.5784284662087202r c;794.1337173263841578r c;889.7352853986262744r c;996.08999826922536158r c;1093.6452871294009128r c;1200.'
    );
  });
